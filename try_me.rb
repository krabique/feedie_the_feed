...
## Uncomment and change these accordingly if you want to provide the keys here, instead of using
## those from environment variables FACEBOOK_APPID and FACEBOOK_SECRET
# facebook_appid = "123"
# facebook_secret = "123"
# @feed_grabber = FeedieTheFeed::FeedGrabber.new(facebook_appid, facebook_secret)
